      ...
      <div className="flex flex-col space-y-1.5 w-full">
        ...
        <div className="relative flex items-center">
          ...
          <input
            ...
            className={cn(
              'w-full bg-slate-50 dark:bg-slate-900/80 border border-slate-300 dark:border-slate-700/80 text-slate-900 dark:text-slate-100 placeholder-slate-400 dark:placeholder-slate-500 rounded-lg text-sm px-3.5 py-2.5 transition-all duration-200 focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500',
              leftIcon && 'pl-10',
              rightIcon && 'pr-10',
